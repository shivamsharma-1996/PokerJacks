...
object WebServicesPlayWallet {
    const val baseUrl = BuildConfig.HOME_URL_PLAY_WALLET
            ...
            val request = original.newBuilder()
                .addHeader(
                    ...
                    getModel<JsonElement>("loginInfo")?.let {
                        ...
                        if (original.url.toUri().path.contains("paymentService")) "Token " + it["token"].string
